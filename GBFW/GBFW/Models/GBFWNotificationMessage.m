...
@implementation GBFWNotificationMessage
...
-(id)init
{
    if (self = [super init])
    {
        ...
        self.foregroundAlertType = GBFWNotificationAlertTypeNone;
        self.backgroundAlertType = GBFWNotificationAlertTypeNone;
        self.backgroundActionType = GBFWNotificationActionTypeNone;
        self.menuReloadType = GBFWNotificationMenuReloadTypeNone;
        self.redirectId = @"";
    }
    return self;
}
